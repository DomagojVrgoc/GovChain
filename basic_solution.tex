...
\caption{A hash list. A secure hash algorithm $h$ is used, and external data prevents predictability. Here we use $\bot$ to denote the default value used as the previous hash in the first block.}
\label{hashlist}
\end{figure}
